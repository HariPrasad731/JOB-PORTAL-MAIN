                ...
                <div className="help-section">
                    ...
                    <div className="help-layout">
                        ...
                        <div className="hc-sidebar">
                            ...
                            {openIndex === 2 && (
                                <div className="hc-submenu">
                                    ...
                                    <Link
                                        to="/Job-portal/jobseeker/help-center/login-issues"
                                        className="hc-submenu-link"
                                    >
                                    ...
                                    <Link
                                        to="/Job-portal/jobseeker/help-center/page-errors"
                                        className="hc-submenu-link"
                                    >
                                    ...
                                    <Link
                                        to="/Job-portal/jobseeker/help-center/file-upload-problems"
                                        className="hc-submenu-link"
                                    >
                        ...
                        <div className="support-options">
                            ...
                            <Link
                                to='/Job-portal/jobseeker/help-center/raise-a-ticket'
                                className="support-item"
                            >
